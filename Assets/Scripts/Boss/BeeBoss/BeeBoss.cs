...
public class BeeBoss : MonoBehaviour, IGunAnimation
{
    ...
    private void BossAttack()
    {
        ...
        if(attackTimer >= attackInterval)
        {
            ...
            if(isLeft) prefab.transform.Rotate(0, 0, 230 + randomAngle, Space.World);  //right angle 210
            else prefab.transform.Rotate(0, 0, -50 + randomAngle, Space.World);       //left angle   -30
